...
#$1=TARGET_DEVICE, $2=PRODUCT_OUT, $3=FILE_NAME $4=PM_BASE_VERSION
existingOTAjson=./vendor/devices/$1.json
output=$2/$1.json
...
if [ -f $existingOTAjson ]; then
	...
	version="$4"
	download="https://sourceforge.net/projects/bliss-rom-kenzo/files/PixelMagic_laurel/$3/download"
